...
const LinkedIn = () => {
  return (
    ...
    <TextGenerateEffectLinkedIn
                  className='lg:max-w-[70vw] font-Stylish text-center md:tracking-wider custom-sm:text-[1rem] md:text-lg lg:text-2xl mb-4'
    ...
    <p className='lg:max-w-[70vw] font-Dancing_Script text-center md:tracking-wider custom-sm:text-[1rem] md:text-lg lg:text-2xl mb-4 dark:text-white'>
        Have a <span className='text-yellow-300'>fantastic day </span>, filled with joy and inspiration!</p>
    </div>
    </>
  )
}
